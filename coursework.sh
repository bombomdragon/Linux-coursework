...
cd ./generated/ && mkdir -p workspace/{scripts,data}
cd ../
...
# 请在下方写下你的命令
cd ./generated/workspace/scripts/ && touch hello.sh utils.sh
cd ../../../
...
# 请在下方写下你的命令
cd ./generated/workspace/scripts/ && echo -e "#!/bin/bash\necho \"Hello, Linux!\"" > hello.sh
cd ../../../
...
# 请在下方写下你的命令
cd ./generated/workspace/ && rm -r data/
cd ../../
...
# 请在下方写下你的命令
cd ./generated/workspace/ && touch info.txt && echo -e "Linux is a powerful operating system.\nBash scripting is fun and useful.\nCommand line tools are essential for developers." > info.txt && grep "Linux" info.txt > result.txt
cd ../../
